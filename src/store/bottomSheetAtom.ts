...
export const openBottomSheet = atom(null, (get, set, bottomSheetKey: keyof typeof BOTTOM_SHEET_KEY) => {
...
export const closeBottomSheet = atom(null, (get, set, bottomSheetKey: keyof typeof BOTTOM_SHEET_KEY) => {
  set(bottomSheetState, {
    ...get(bottomSheetState),
...
export const toggleBottomSheet = atom(null, (get, set, bottomSheetKey: keyof typeof BOTTOM_SHEET_KEY) => {
  set(bottomSheetState, {
    ...get(bottomSheetState),
