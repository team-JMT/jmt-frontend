          ...
          <FilterContainer>
            {liquorKeyList.map((item: string) => {
              ...
              return (
                ...
                >
                  <FilterIcon iconName={item} color={localDrink === item ? colors.main500 : colors.gray300} />
                  {value}
                </FilterBox>
              );
            })}
          </FilterContainer>
          <FooterButton type={'DRINK_CATEGORY'} drinkChecked={localDrink as keyof typeof LiquorKey} />
        </>
      }
    ></BottomSheetCompoenet>
  );
